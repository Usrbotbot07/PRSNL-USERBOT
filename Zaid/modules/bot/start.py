...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("✘ ⚡𝗗𝗘𝗣𝗟𝗢𝗣𝗘𝗥⚡", url="t.me/TriGO_Bot_Support"),
            ],
            [
                InlineKeyboardButton("✘ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="t.me/TriGO_Bot_Support"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f"Your 💘INJOY TRIGO USRBOT As {user.first_name} ✅.")
